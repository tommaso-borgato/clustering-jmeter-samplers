 ...
 */
public class ClusteringHTTPRequestSamplerGranularityAttribGroups extends AbstractJavaSamplerClient implements Serializable {


    private static final Logger LOG = LoggerFactory.getLogger(ClusteringHTTPRequestSamplerGranularityAttribGroups.class);
    ...
    private void setSampleResponseData(HttpResponse response) throws IOException {
        ...
        if (1==1) {
            ...
            throw new IllegalStateException(String.format("Invalid serial: Expected %d, received %s", serial, numberFromServer));
        }
    }
